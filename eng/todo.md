...
- [x] src/tools.rs:103 schemas is 99 lines of pure data (cognitive score 0). Low priority: consider a constant or one schema per tool. Planned in eng/plans/2026-09-23-008-tool-schemas.md.
