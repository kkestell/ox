...
///
/// Each built-in provider lives in its own project (e.g. Ox.Agent.Providers.Google,
/// Ox.Agent.Providers.OpenAI) so provider-specific NuGet dependencies are isolated.
