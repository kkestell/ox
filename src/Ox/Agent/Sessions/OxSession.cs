...
/// <summary>
/// A single conversation session within the Ox agent system.
///
...
/// a message. A session is created via <see cref="Hosting.OxHost.CreateSession"/> (new)
/// or <see cref="Hosting.OxHost.OpenSessionAsync"/> (resume from disk).
///
...
public sealed class OxSession : IAsyncDisposable
{
    ...
    ///
    /// This is the correct layer for command execution: OxSession holds
