...
/// registration loop in <see cref="Ox.Agent.Sessions.OxSession"/> builds a
...
internal static class BuiltinToolFactories
{
    ...
    /// Consumed by the registration loop in <see cref="Ox.Agent.Sessions.OxSession.RunTurnAsync"/>.
    ///
