...
/// <summary>
/// The public API surface for reading and writing Ox configuration.
///
/// Configuration is split across three backing stores:
///   • <see cref="IOptionsMonitor{OxOptions}"/> — strongly-typed core settings
...
public sealed class OxConfiguration
{
    ...
    private readonly IOptionsMonitor<OxOptions> _optionsMonitor;
    private readonly SettingsWriter _settingsWriter;
    private readonly IKeyring _keyring;
    private readonly ProviderRegistry _providerRegistry;

    internal OxConfiguration(
    ...
    /// OxOptions (e.g. --fake-provider mode), that takes priority. Otherwise
