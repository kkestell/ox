...
namespace Ox.Agent.Configuration.Keyring;
...
///
/// The service parameter is ignored because all Ox keyring lookups use the same
/// service name ("ur"). We key only on the account (provider name) to keep the
/// env var naming simple.
/// </summary>
internal sealed partial class EnvironmentKeyring : IKeyring
{
    /// <summary>
