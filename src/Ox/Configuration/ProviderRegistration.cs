...
/// <see cref="Ur.Providers.OpenAiCompatible.OpenAiCompatibleProvider"/> for
            ...
            switch (name)
            {
                case "openai":
                    ...
                    services.AddSingleton<IProvider>(sp =>
                        new Ur.Providers.OpenAI.OpenAiProvider(
                            sp.GetRequiredService<IKeyring>(), openAiEndpoint));
                    break;

                case "google":
                    services.AddSingleton<IProvider>(sp =>
                        new Ur.Providers.Google.GoogleProvider(
                ...
                case "openrouter":
                    ...
                    services.AddSingleton<IProvider>(sp =>
                        new Ur.Providers.OpenRouter.OpenRouterProvider(
                ...
                case "ollama":
                    ...
                    services.AddSingleton<IProvider>(
                        new Ur.Providers.Ollama.OllamaProvider(ollamaEndpoint));
                    break;

                case "zai-coding":
                    var zaiEndpoint = entry.Endpoint;
                    services.AddSingleton<IProvider>(sp =>
                        new Ur.Providers.ZaiCoding.ZaiCodingProvider(
                ...
                default:
                    ...
                    services.AddSingleton<IProvider>(sp =>
                        new Ur.Providers.OpenAiCompatible.OpenAiCompatibleProvider(
