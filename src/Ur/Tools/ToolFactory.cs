...
///
/// All tool registrations — builtins, extensions, and future tool types — use
/// this single delegate shape. The registration loop has zero branching: build
/// context once, call every factory, register every result.
/// </summary>
