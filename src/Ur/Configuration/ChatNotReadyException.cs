...
/// <summary>
/// Thrown by <see cref="UrSession.RunTurnAsync"/> when the system lacks a
/// required pre-condition (API key, model selection). Carries the
/// <see cref="Readiness"/> snapshot so the caller can display specific issues.
/// </summary>
