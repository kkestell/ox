...
public sealed class ConsoleBufferTests
{
    ...
    public void DemoFrame_DoesNotLetRecentEventsOverwriteStatusRows()
    {
        ...
        var stateType = typeof(Te.Program).GetNestedType("DemoState", BindingFlags.NonPublic);
        ...
        var drawFrame = typeof(Te.Program).GetMethod("DrawFrame", BindingFlags.Static | BindingFlags.NonPublic);
