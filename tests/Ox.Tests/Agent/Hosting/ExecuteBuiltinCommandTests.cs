...
namespace Ox.Tests.Agent.Hosting;

/// <summary>
/// Tests for <see cref="Sessions.OxSession.ExecuteBuiltInCommand"/>.
///
...
public sealed class ExecuteBuiltinCommandTests
{
    ...
    private static async Task<OxHost> CreateHostAsync(TempWorkspace workspace) =>
