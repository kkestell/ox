...
/// <summary>
/// Integration tests for slash command handling in OxSession. These verify
/// the full path: user types "/skill-name args" → OxSession expands the skill
...
public sealed class SkillSessionTests : IDisposable
{
    ...
    private async Task<OxHost> StartHostAsync(IChatClient? client = null)
    {
