...
public sealed class WordWrapTests
{
    ...
    {
        var result = Ox.Views.TextLayout.WrapText("Hello", 20);
    ...
    {
        var result = Ox.Views.TextLayout.WrapText("12345", 5);
        Assert.Single(result);
    ...
    {
        var result = Ox.Views.TextLayout.WrapText("Hello world", 7);
    ...
    {
        var result = Ox.Views.TextLayout.WrapText("abcdefghij", 5);
        Assert.Equal(2, result.Count);
    ...
    {
        var result = Ox.Views.TextLayout.WrapText("Line1\nLine2", 20);
        Assert.Equal(2, result.Count);
    ...
    {
        var result = Ox.Views.TextLayout.WrapText("Hello\n", 20);
        Assert.Single(result);
        Assert.Equal("Hello", result[0]);
    }
    ...
    {
        var result = Ox.Views.TextLayout.WrapText("", 20);
        Assert.Single(result);
    ...
    {
        var result = Ox.Views.TextLayout.WrapText("A\n\nB", 20);
    ...
    public void WrapText_SpaceAtBoundary_SplitsCleanly()
    {
        ...
        var result = Ox.Views.TextLayout.WrapText("hello world", 5);
        Assert.Equal(2, result.Count);
        Assert.Equal("hello", result[0]);
        Assert.Equal("world", result[1]);
    }
